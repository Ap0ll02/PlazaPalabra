...
const WORD_ORDER_NOTES := {
	...
	"adjective_after_noun": "In Spanish, a describing word like a color goes AFTER the noun: \"rayo morado\" (bolt purple), where English says \"purple bolt\".",
...
const SPELLS := {
	...
	"rayo_morado": {
		"order_foil": "Yo disparo un morado rayo", "order_pattern": "adjective_after_noun",
		"name": "Purple Bolt", "name_es": "Rayo Morado",
		"type": "attack", "target": "single", "source": "week2_bandits",
		"sentence_es": "Yo disparo un rayo morado", "sentence_en": "I shoot a purple lightning bolt",
		"accepted_en": ["I shoot a purple lightning bolt", "I fire a purple lightning bolt", "I shoot a purple bolt", "I shoot a purple bolt of lightning", "I am shooting a purple lightning bolt", "I'm shooting a purple lightning bolt"],
		"accepted_es": ["Yo disparo un rayo morado", "Disparo un rayo morado"],
		"mana_cost": 5, "base_accuracy": 15, "power": 34,
		"slots": [
			YO_SLOT,
			{"role": "verb", "word_id": "disparar", "es": "disparo", "en": "shoot",
				"distractors": [{"es": "disparas", "en": "you shoot"}, {"es": "disparan", "en": "they shoot"}]},
			{"role": "object", "word_id": "rayo_morado", "es": "un rayo morado", "en": "a purple lightning bolt",
				"distractors": [{"es": "un morado rayo", "en": "a purple lightning bolt"}, {"es": "un rayo verde", "en": "a green lightning bolt"}]},
		],
		"combined": {
			"sentence_es": "Yo disparo un rayo morado con fuerza",
			"sentence_en": "I shoot a purple lightning bolt with force",
			"phrase": FUERZA_PHRASE,
		},
	},
	"viento_plateado": {
		"order_foil": "Tú sientes un plateado viento", "order_pattern": "adjective_after_noun",
		"name": "Silver Wind", "name_es": "Viento Plateado",
		"type": "attack", "target": "all", "source": "week2_jungle_beast",
		"sentence_es": "Tú sientes un viento plateado", "sentence_en": "You feel a silver wind",
		"accepted_en": ["You feel a silver wind", "You are feeling a silver wind", "You feel a silvery wind"],
		"accepted_es": ["Tú sientes un viento plateado", "Sientes un viento plateado"],
		...
		"slots": [
			...
			{"role": "object", "word_id": "viento_plateado", "es": "un viento plateado", "en": "a silver wind",
				"distractors": [{"es": "un plateado viento", "en": "a silver wind"}, {"es": "un viento dorado", "en": "a golden wind"}]},
		],
		"combined": {
			"sentence_es": "Tú sientes un viento plateado con fuerza",
			"sentence_en": "You feel a silver wind with force",
			"phrase": FUERZA_PHRASE,
		},
	},
	"luz_dorada": {
		"order_foil": "Yo siento una dorada luz", "order_pattern": "adjective_after_noun",
		"name": "Golden Light", "name_es": "Luz Dorada",
		"type": "heal", "target": "self", "source": "week2_jungle_floor",
		"sentence_es": "Yo siento una luz dorada", "sentence_en": "I feel a golden light",
		"accepted_en": ["I feel a golden light", "I am feeling a golden light", "I feel a gold light", "I feel a golden glow"],
		"accepted_es": ["Yo siento una luz dorada", "Siento una luz dorada"],
		"mana_cost": 4, "base_accuracy": 35, "power": 40,
		"slots": [
			YO_SLOT,
			{"role": "verb", "word_id": "sentir", "es": "siento", "en": "feel",
				"distractors": [{"es": "sientes", "en": "you feel"}, {"es": "sienten", "en": "they feel"}]},
			{"role": "object", "word_id": "luz_dorada", "es": "una luz dorada", "en": "a golden light",
				"distractors": [{"es": "una dorada luz", "en": "a golden light"}, {"es": "una luz plateada", "en": "a silver light"}]},
		],
	},
	"muro_de_piedra": {
